...
import MealsDesktopView from '@/components/desktop-views/MealsDesktopView';
import MealsMobileView from '@/components/mobile-views/MealsMobileView';
...
export default async function MealsPage() {
  ...
  try {
    const sheetId = process.env.MEALS_SHEET_ID;
        ...
        {!error && sheetData && (
          <>
            ...
            <div className="hidden md:block">
              <MealsDesktopView data={sheetData} />
            </div>

            {/* Mobile View */}
            <MealsMobileView data={sheetData} />
          </>
        )}
